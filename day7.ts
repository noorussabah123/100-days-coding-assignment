...
let numOfGuests: string[] = ["Maryam", "Hiba", "Mahnoor", "Ayesha"];

console.log(`I am inviting ${numOfGuests.length} people for dinner`);
...
let cities: string[] = ["Islamabad", "Kohat", "Quetta", "Peshawar"]
...
console.log(`Book Info ${book.title}, Author Name ${book.author}, Published In ${book.yearPublished}`);
