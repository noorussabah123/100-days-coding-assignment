...
let famousPerson = "Once Wintson Churchill said: Success is going from failure to failure without loss of enthusiasm";
...
let famous_person = "Thomas A. Edison";
let quote = `${famous_person} once said: "The secret of success is focus of purpose"`;
console.log(quote);
